...
<head>
    ...
    <title>Muhammad Prayoga Putra Mahardhika - Profil</title>
...
<body>
    <header class="header">
        <div class="container">
            <h1 class="display-4">Muhammad Prayoga Putra Mahardhika</h1>
        ...
        <div class="row">
            <div class="col-md-4 text-center">
                ...
                <div class="mt-3 social-icons">
                    <a href="https://www.linkedin.com/in/muhammad-prayoga-putra-mahardhika-916143238/"><i class="fab fa-linkedin"></i></a>
                    <a href="https://github.com/MuhammadPrayoga"><i class="fab fa-github"></i></a>
                    <a href="https://www.instagram.com/mprayogapm/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
            <div class="col-md-8">
